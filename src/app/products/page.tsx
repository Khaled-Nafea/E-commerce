...
import { Star, Plus, RefreshCw, Eye, PackageOpen } from 'lucide-react';
import Link from 'next/link';
import { Button } from '@/components/ui/button';
import BreadCrumb from '@/components/BreadCrumb/BreadCrumb';
import { getProducts } from '@/services/healperServices';
...
export default async function Products() {
  ...
  return (
    <>
    <BreadCrumb title="All products" description="Browse our wide range of product categories" gradient="from-green-600 via-green-500 to-green-300"
     iconBg="bg-[#4AC577]" icon={PackageOpen} breadcrumbs={[{ label: "Home", href: "/" },{ label: "Products" }]} />
